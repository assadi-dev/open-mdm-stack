...
export const commandType = ["lock", "unlock", "reboot", "set_lock_message", "remove_device_owner", "factory_reset", "clear_apps_data", "run_app", "uninstall_app", "install_app", "block_app", "unblock_app", "kiosk_mode", "get_location", "get_wifi_list", "remote_cast", "stop_remote_cast"] as const;
/**
